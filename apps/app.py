...
from sensd_sers_analysis.report import (
    build_phase1_qa_pdf,
...
# ---------------------------------------------------------------------------
# 6. Phase 2: Serotyping & Classification
# ---------------------------------------------------------------------------
with tab_phase2:
    st.markdown(
        "#### Phase 2: Serotyping & Classification\n"
    ...
    if not has_phase2_cols:
        ...
        if phase2_clean.empty:
            ...
            try:
                ...
                if st.button(
                    "Generate Phase 2 Classification Report", key="phase2_pdf_btn"
                ):
                    try:
